                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="nama_persyaratan" required placeholder="Nama Persyaratan" value="<?= $persyaratan->nama_persyaratan ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
