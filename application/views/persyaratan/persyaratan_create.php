<div class="dashboard-wrapper">
    <div class="container-fluid dashboard-content">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">Tambah Data Persyaratan</div>
                    <div class="card-body">
                        <form action="<?= base_url('persyaratan/create') ?>" method="post">
                            <div class="form-group row">
                                <label class="col-md-2">Nama Persyaratan</label>
                                <div class="col-md-10">
                                    <input type="text" name="nama_persyaratan" required placeholder="Nama Persyaratan" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
